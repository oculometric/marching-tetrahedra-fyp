...
\end{tabular}
\end{center}
    \caption{Table for sample position offset vectors, for the body-centered tetrahedron arrangement. The $X$, $Y$, and $Z$ columns represent components of the vector which represents moving from the current sample point to its neighbour in the direction specified by the first column.}
