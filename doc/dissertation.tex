...
\emph{I want to thank \textbf{Kieran Osborne} for being a fantastic supervisor throughout this project. I also want to thank \textbf{Lucy} and \textbf{Louise} for looking out for me and listening to me excitedly ramble, as well as all of my housemates and friends. Thankyou.}
...
\begin{singlecolfigure}
    \centering
    \includegraphics[width=0.6\textwidth]{elastic surface nets.jpg}
...
The implementation produced was based closely on the regularised marching tetrahedra algorithm (Treece, Prager, and Gee, 1999). However, several adaptations were made in order to produce ideal results for videogame terrain.

The specifics of our algorithm are detailed in pseudocode in Algorithms \ref{algo:pseudocode1}, \ref{algo:pseudocode2}, and \ref{algo:pseudocode3}. These correspond to the three computation stages - sampling, vertex creation, or geometry generation.
...
\end{subfigure}
\caption{Images of mesh output for the sphere with a low sample resolution, using a body-centered arrangement with the integrated clustering algorithm. Flat shading is shown in the center, with the wireframe shown on the right As can be seen, the algorithm produces appropriate results for both smooth and flat mesh shading scenarios..}
