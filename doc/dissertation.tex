...
\begin{singlecolfigure}
\centering
  \includegraphics[width=.85\linewidth]{renders/bunny03_s.png} 
  \includegraphics[width=.85\linewidth]{renders/bunny03_ws.png}
\captionof{figure}{Images of mesh output for the Stanford Bunny, using a body-centered arrangement with the integrated clustering algorithm, with the wireframe shown below.}
\label{fig:imagesout}
\end{singlecolfigure}
...
\captionof{figure}{Images of mesh output for the sphere with a low sample resolution, using a body-centered arrangement with the integrated clustering algorithm. Smooth shading is shown at the top, flat shading in the middle, and the wireframe at the bottom. As can be seen, the algorithm produces appropriate results for both smooth and flat mesh shading scenarios.}
